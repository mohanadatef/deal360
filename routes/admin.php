...
use App\Http\Controllers\Admin\Acl\AgentController;
...
Route::group(['middleware'=> 'admin', 'auth','language','log','permission:dashboard-show'],function()
{
	/*dashboard list*/
	...
	/* status route list */
	Route::apiresource('status',StatusController::class,['except'=>['show','update']])->parameters(['status'=>'id']);
	...
	/* type route list */
	Route::apiresource('type',TypeController::class,['except'=>['show','update']])->parameters(['type'=>'id']);
	...
	/* country route list */
	Route::apiresource('country',CountryController::class,['except'=>['show','update']])->parameters(['country'=>'id']);
	...
	/* amenity route list */
	Route::apiresource('amenity',AmenityController::class,['except'=>['show','update']])->parameters(['amenity'=>'id']);
	...
	/* city route list */
	Route::apiresource('city',CityController::class,['except'=>['show','update']])->parameters(['city'=>'id']);
	...
	/* package route list */
	Route::resource('package',PackageController::class,['except'=>['show','update']])->parameters(['package'=>'id']);
	...
	Route::apiresource('highlight',HighLightController::class,['except'=>['show','update']])
		->parameters(['highlight'=>'id']);
	...
	/* rejoin route list */
	Route::apiresource('rejoin',RejoinController::class,['except'=>['show','update']])->parameters(['rejoin'=>'id']);
	...
	/* Setting route list */
	/* meta route list */
	Route::apiresource('meta',MetaController::class,['except'=>['show','update']])->parameters(['meta'=>'id']);
	...
	/* fq route list */
	Route::apiresource('fq',FQController::class,['except'=>['show','update']])->parameters(['fq'=>'id']);
	...
	/* role route list */
	Route::resource('role',RoleController::class,['except'=>['show','update']])->parameters(['role'=>'id']);
	...
	/* user route list */
	Route::resource('user',UserController::class,['except'=>['show','update']])->parameters(['user'=>'id']);
	...
	/* agency route list */
	Route::resource('agency',AgencyController::class,['except'=>['show','update']])->parameters(['agency'=>'id']);
	...
	/* agent route list */
	Route::resource('agent',AgentController::class,['except'=>['show','update']])->parameters(['agent'=>'id']);
	Route::prefix('/agent')->name('agent.')->group(function()
	{
		...
		Route::post('/{id}',[AgentController::class,'update'])->name('update');
	});
});
