...
class CreateForeignKeys extends Migration
{
	public function up()
	{
		...
		{
			$table->foreign('user_id')->references('id')->on('users')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('rejoin_id')->references('id')->on('rejoins')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('country_id')->references('id')->on('countries')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('city_id')->references('id')->on('cities')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('type_id')->references('id')->on('types')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('high_light_id')->references('id')->on('high_lights')->onDelete('cascade')
				->onUpdate('restrict');
		...
		{
			$table->foreign('amenity_id')->references('id')->on('amenities')->onDelete('cascade')->onUpdate('restrict');
			$table->foreign('property_id')->references('id')->on('properties')->onDelete('cascade')
				->onUpdate('restrict');
		});
