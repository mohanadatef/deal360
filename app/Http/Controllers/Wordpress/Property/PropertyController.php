                ...
                foreach($response['data'] as $key=>$property)
                {
                    ...
                    if($property['language_code']=='en')
                    {
                        ...
                        if(!in_array($property['wp_id'],$wp_properties_id))
                        {
                            ...
                            executionTime();
                            $data_property[]=array('id'            =>$property['wp_id']+$count_property,
                                                   ...
                                                   'country_id'    =>1,'rejoin_id'=>1,'order'=>$property['wp_id']+$count_property,
                            ...
                            foreach($language as $lang)
                            {
                                ...
                                $data_translation[]=array('category_type'=>Property::class,
                                                          'category_id'  =>$property['wp_id']+$count_property,'key'=>'title',
                                                          'value'        =>!empty($property['title'][$lang->code])?$property['title'][$lang->code]:" ",
                                                          'language_id'  =>$lang->id);
                                $data_translation[]=array('category_type'=>Property::class,
                                                          'category_id'  =>$property['wp_id']+$count_property,'key'=>'description',
                                                          'value'        =>!empty($property['description'][$lang->code])?$property['description'][$lang->code]:" ",
                                                          'language_id'  =>$lang->id);
                                $data_translation[]=array('category_type'=>Property::class,
                                                          'category_id'  =>$property['wp_id']+$count_property,'key'=>'address',
                            ...
                            if(!empty($property['image']))
                            {
                                ...
                                {
                                    executionTime();
                                    $image[]=array('id'=>$property['wp_id']+$count_property,'image_url'=>$property_image);
                                }
                            }
                            executionTime();
                            if(!empty($property['photographer']))
                            {
                                ...
                                {
                                    executionTime();
                                    $photographer[]=array('property_id'=>$property['wp_id']+$count_property,'user_id'=>Auth::id(),
                            ...
                            if(!empty($property['property_features']))
                            {
                                ...
                                {
                                    executionTime();
                                    $amenity_property[]=array('property_id'=>$property['wp_id']+$count_property,
                            ...
                            if(!empty($property['plans']))
                            {
                                ...
                                {
                                    executionTime();
                                    $floor_plan[]=array('id'         =>$property['wp_id']+$count_property,
                                                        'property_id'=>$property['wp_id']+$count_property,
                                    ...
                                    {
                                        executionTime();
                                        $image_plan[]=array('id'       =>$property['wp_id']+$count_property,
                                    ...
                                    foreach($language as $lang)
                                    {
                                        ...
                                        $data_translation[]=array('category_type'=>PropertyFloorPlan::class,
                                                                  'category_id'  =>$property['wp_id']+$count_property,
                                                                  'key'          =>'title',
