                        ...
                        <div class="card-body">
                            <div class="form-group{{ $errors->has('title') ? ' is-invalid' : "" }}">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                       value="{{Request::old('title')}}" placeholder="Enter title">
                            </div>
                            <div class="form-group{{ $errors->has('code') ? ' is-invalid' : "" }}">
                                <label for="code">Code</label>
                                <input type="text" name="code" class="form-control" id="code"
                                       value="{{Request::old('code')}}" placeholder="Enter Code">
                            </div>
...
@section('script_style')
    ...
    <script>
        ...
        function CreateItem(res) {
            $('#body').append(`<tr id="${res.id}"><td id="title-${res.id}">${res.title}</td>
                            <td id="code-${res.id}" data-order="${res.order}">${res.code}</td>
