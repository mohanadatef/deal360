                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @forelse($datas as$index => $data)
                                        <tr id="data-{{$data->id}}">
                                            ...
                                            <td>
                                              <img src="{{ image_get($data->image,'country') }}" style="width:100px;height: 100px">
                                            </td>
                                            <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-warning">
                <div class="modal-header">
                    <h4 class="modal-title">Restore Country</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Are you Need To Restore This Country and all city and area use this country</p>
                    <!-- /.card-body -->
    ...
    <div class="modal fade" id="modal-remove">
        <div class="modal-dialog">
            <div class="modal-content bg-warning">
                ...
                <div class="modal-body">
                    <p>Are you Need To Delete This Country and all city and area use this country</p>
                </div>
                <div class="modal-footer justify-content-between">
