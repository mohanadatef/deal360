                            ...
                            <form action="{{route('developer.store')}}" method="post" id="create" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group{{ $errors->has('username') ? ' is-invalid' : "" }}">
                                        <label for="username">{{trans('lang.Agent_Name')}}</label>
                                        <input type="text" name="username" class="form-control" id="username"
                                               value="{{Request::old('username')}}"
                                               placeholder="{{trans('lang.Enter_Agent_Name')}}">
                                    </div>
...
@section('script_style')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Acl\Agent\CreateRequest','#create') !!}
@endsection
