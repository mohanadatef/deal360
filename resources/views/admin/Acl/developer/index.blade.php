                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            @permission('developer-status')
                                            <th>{{trans('lang.Status')}}</th>
                                            @endpermission
                                            @permission('developer-approve')
                                        ...
                                        @forelse($datas as $data)
                                            <tr id="data-{{$data->id}}">
                                                ...
                                                @endpermission
                                                <td>
                                                    @permission('developer-edit')
                                                    <a href="{{  route('developer.edit',$data->id) }}"
                                                       class="btn btn-outline-primary btn-block btn-sm"><i class="fa fa-edit"></i>{{trans('lang.Edit')}}</a>
                                                    @endpermission
                                                    @permission('developer-forgot-password')
                                                    <button type="button"
